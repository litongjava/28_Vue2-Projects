...
<div class="case-num">
  <div class="container">
    <div class="title">
      <span>截止 {{parseDate(caseNum.modifyTime)}} 全国数据统计</span>
    </div>
  </div>
  <div class="num">
    <ul class="count">
      <li class="create-item-">
        <div class="create-count">
          <b>较昨日 <em style="color:rgb(247,76,49)">{{numZero(caseNum.currentConfirmedIncr)}}</em></b>
        </div>
      ...
      <li class="create-item-">
        <div class="create-count">
          <b>较昨日 <em style="color:rgb(247,130,7)">{{numZero(caseNum.confirmedIncr)}}</em></b>
        </div>
      ...
      <li class="create-item-">
        <div class="create-count">
          <b>较昨日 <em style="color:rgb(162,90,78)">{{numZero(caseNum.suspectedIncr)}}</em></b>
        </div>
      ...
      <li class="create-item-">
        <div class="create-count">
          <b>较昨日 <em style="color:rgb(174,33,44)">{{numZero(caseNum.curedIncr)}}</em></b>
        </div>
      ...
      <li class="create-item-">
        <div class="create-count">
          <b>较昨日 <em style="color:rgb(93,112,146)">{{numZero(caseNum.deadIncr)}}</em></b>
        </div>
      ...
      <li class="create-item-">
        <div class="create-count">
          <b>较昨日 <em style="color:rgb(40,183,163)">{{numZero(caseNum.seriousIncr)}}</em></b>
        </div>
